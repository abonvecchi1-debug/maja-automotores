...
const mapVehicle = (r) => ({
  ...
  acquiredAs: n(r.acquired_as), tradeInFromClientId: n(r.trade_in_from_client_id),
  tradeInSourceVehicleId: n(r.trade_in_source_vehicle_id), purchaseSupplierId: n(r.purchase_supplier_id),
