...
function exportPDF(data: BalanceData) {
  const { periodo, resumen, ventas, compras, gastos, gastos_fijos } = data;
  const doc = new jsPDF();
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                <div key={i} className={`flex justify-between py-1.5 ${i === 2 || i === 5 ? 'border-t border-gray-200 mt-1 pt-2' : ''}`}>
